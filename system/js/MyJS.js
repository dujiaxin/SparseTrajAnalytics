            ...
            if (MyTB === "tds") {
                ...
                $.post("/TrajVis/system/query.php", {
                    ...
                    if (results) {
                        var obj = [];
                        obj = JSON.parse(results);
                        StoreInfo(stcor, obj["Draw"], obj["WeekDays"], obj["DayHours"], obj["road_Array"], obj["Trip_Rank"], obj["St_Rank_count"], obj["St_Rank_speed"], type, edit, newQuery.QueryId, color, obj["Data_For_SCP"]);
                    } else {
                        console.log("No Results");
                    }
                });
                ...
                $.post("/TrajVis/system/Rquery.php", {
                    ...
                    if (results) {
                        ...
                        obj = JSON.parse(results);
                        //console.log(obj);
                        StoreInfo(stcor, obj["Draw"], obj["WeekDays"], obj["DayHours"], obj["region_Array"], obj["Trip_Rank"], obj["St_Rank_count"], obj["St_Rank_speed"], type, edit, newQuery.QueryId, color, obj["Data_For_SCP"]);
                    } else {
                        console.log("No Results");
                    }
                });
                    ...
                    if (results) {
                        ...
                        $.post("/TrajVis/system/query_edit.php", {
                            ...
                            if (results) {
                                ...
                                StoreInfo(ComplexQueryList, FinalResults, obj1["WeekDays"], obj1["DayHours"], obj1["road_Array"], obj1["Trip_Rank"], obj1["St_Rank_count"], obj1["St_Rank_speed"], "C", edit, editQId, color,obj1["Data_For_SCP"]);
                                ComplexQueryList = []
                                edit = 0;
                                var Qu = vis.QueryManager.GetQueryByQueryId(editQId)
                                Qu.Complex = 1
                    ...
                    if (results) {
                        ...
                        $.post("/TrajVis/system/Rquery_edit.php", {
                            ...
                            if (results) {
                                ...
                                //console.log(obj1)
                                //console.log(FinalResults)
                                StoreInfo(ComplexQueryList, FinalResults, obj1["WeekDays"], obj1["DayHours"], obj1["region_Array"], obj1["Trip_Rank"], obj1["St_Rank_count"], obj1["St_Rank_speed"], "C", edit, editQId, color,obj1["Data_For_SCP"]);
                                ComplexQueryList = []
                                edit = 0;
                                var Qu = vis.QueryManager.GetQueryByQueryId(editQId)
                                Qu.Complex = 1
                                ...
                                if (results) {
                                    ...
                                    $.post("/TrajVis/system/Rquery_edit.php", {
                                        ...
                                        if (results) {
                                            var obj1 = [];
                                            obj1 = JSON.parse(results);
                                            StoreInfo(ComplexQueryList, FinalResults, obj1["WeekDays"], obj1["DayHours"], obj1["region_Array"], obj1["Trip_Rank"], obj1["St_Rank_count"], obj1["St_Rank_speed"], "C", edit, editQId, color);
                                            ComplexQueryList = []
                                            edit = 0;
                                            var Qu = vis.QueryManager.GetQueryByQueryId(editQId)
                                            Qu.Complex = 1
                                ...
                                if (results) {
                                    ...
                                    $.post("/TrajVis/system/Nquery_edit.php", {
                                        ...
                                        if (results) {
                                            var obj1 = [];
                                            obj1 = JSON.parse(results);
                                            StoreInfo(ComplexQueryList, FinalResults, obj1["WeekDays"], obj1["DayHours"], obj1["region_Array"], obj1["Trip_Rank"], obj1["St_Rank_count"], obj1["St_Rank_speed"], "C", edit, editQId, color, obj["Data_For_SCP"]);
                                            ComplexQueryList = []
                                            edit = 0;
                                            var Qu = vis.QueryManager.GetQueryByQueryId(editQId)
                                            Qu.Complex = 1
...
//*****************************************************************************************************************************************
function StoreInfo(parameters, results, WeekDays, DayHours, road_Array, Trip_Rank, St_Rank_count, St_Rank_speed, type, Complex, Id, Qcolor, data_For_SCP) {
