         ...
         <div id='map2'></div>
            ...
            <div id="tabs-1">
               ...
               <div id="exTab3" class="container">
                ...
                <div class="panel panel-default" id="chooseReportView_panel">
                    <div class="panel-heading">
                        <p>Choose Report View</p>
                        <div id="switchReportView" class="btn-group btn-group-sm" role="group">
                            <button type="button" class="btn btn-default" id="DayHours_btn">DayHours</button>
                            <button type="button" class="btn btn-default" id="WeekDays_btn">WeekDays</button>
                            <button type="button" class="btn btn-default" id="Months_btn">Months</button>
                            <button type="button" class="btn btn-default" id="Years_btn">Years</button>
                        </div>
                    </div>

                    <div class="panel-body">
                        <div id="top1">
                                <span id="span1" class="glyphicon glyphicon-floppy-save"
                                      style="z-index:10; color: black; display: inline-block; position: absolute; top: 10vh; right: 10px;"></span>
                            <div class="reportView">
                                <svg id="v1"></svg>
                            </div>
                        </div>

                        <div id="bottom1" style="display: none;">
                                <span id="span2" class="glyphicon glyphicon-floppy-save"
                                      style="z-index:10; color: black; display: inline-block; position: absolute; top: 10vh; right: 10px;"></span>
                            <div class="reportView">
                                <svg id="v2"></svg>
                            </div>
                        ...
                        <div id="Months_reportView" style="display: none;">
                                <span id="Months_span" class="glyphicon glyphicon-floppy-save"
                                      style="z-index:10; color: black; display: inline-block; position: absolute; top: 10vh; right: 10px;"></span>
                            <div class="reportView">
                                <svg id="v3" class="container-fluid"></svg>
                            </div>
                        </div>

                        <div id="Years_reportView" style="display: none;">
                                <span id="Years_span" class="glyphicon glyphicon-floppy-save"
                                      style="z-index:10; color: black; display: inline-block; position: absolute; top: 10vh; right: 10px;"></span>
                            <div class="reportView">
                                <svg id="v4"></svg>
                            </div>
